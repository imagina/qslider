<template>
  <div id="sliderIndex"
       class="q-layout-page row layout-padding relative-position">
    ...
    <div class="col-12 text-right q-my-sm">
      ...
      <q-btn-group class="q-mr-sm">
        <q-btn icon="fas fa-align-justify" @click="viewTable = true"/>
        <q-btn icon="fas fa-th" @click="viewTable = false"/>
      </q-btn-group>
      <q-btn color="primary"
             icon="fas fa-sync"
            ...
            <div v-if="sliderToEdit.id" class="col-12 col-md-7 text-right">
              ...
              <draggable  v-model="sliderToEdit.slides" group="slides">
                <div v-for="(slide,index) in sliderToEdit.slides" :key="'slide'+index"
                     :style="'background-image: url('+slide.imageUrl+'); position:relative'" class="image border q-my-sm col-12 col-sm-4 col-md-3">
              
                  <div style="bottom: 5px; right: 5px; position: absolute;">
                    <q-btn icon="fas fa-pen" color="positive" round size="xs" class="q-mx-xs" @click="showSlideModal(slide)"/>
                    <q-btn icon="far fa-trash-alt" color="negative" size="xs" class="q-mx-xs" round @click="deleteSlide(slide.id, index)"/>
        ...
        <div class="layout-padding">
          ...
          <div class="row gutter-xs" v-if="locale.success">
            ...
            <div class="col-12">
              ...
              <q-field
              >
                <q-input :float-label="'Caption ('+locale.language+')'" type="text" v-model="locale.formTemplate.caption" />
              </q-field>
              ...
              <q-field
              >
                <q-input :float-label="'External Image Url ('+locale.language+')'" type="text" v-model="locale.formTemplate.externalImageUrl" />
              </q-field>
